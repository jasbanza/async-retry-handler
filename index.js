 ...
 * @param {Function} [options.successCriteria] - An (optionally async) function that determines if the operation response was successful. It must return a boolean based on your success criteria.
